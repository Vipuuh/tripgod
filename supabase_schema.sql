...
-- Premium Tour Marketplace Listing Enhancements (June 2026)
ALTER TABLE tours ADD COLUMN IF NOT EXISTS is_verified BOOLEAN DEFAULT true;
ALTER TABLE tours ADD COLUMN IF NOT EXISTS is_bestseller BOOLEAN DEFAULT false;
ALTER TABLE tours ADD COLUMN IF NOT EXISTS is_instant_confirmation BOOLEAN DEFAULT true;
ALTER TABLE tours ADD COLUMN IF NOT EXISTS seats_left INTEGER DEFAULT 10;
ALTER TABLE tours ADD COLUMN IF NOT EXISTS bookings_count INTEGER DEFAULT 150;
ALTER TABLE tours ADD COLUMN IF NOT EXISTS hotel_included BOOLEAN DEFAULT true;
ALTER TABLE tours ADD COLUMN IF NOT EXISTS meals_included BOOLEAN DEFAULT true;
ALTER TABLE tours ADD COLUMN IF NOT EXISTS transport_included BOOLEAN DEFAULT true;
...
ALTER TABLE rafting ADD COLUMN IF NOT EXISTS commission_amount NUMERIC;
ALTER TABLE bikes ADD COLUMN IF NOT EXISTS commission_amount NUMERIC;
ALTER TABLE tours ADD COLUMN IF NOT EXISTS commission_amount NUMERIC;
ALTER TABLE hotels ADD COLUMN IF NOT EXISTS commission_amount NUMERIC;

ALTER TABLE hotels ADD COLUMN IF NOT EXISTS commission_type TEXT DEFAULT 'flat';
ALTER TABLE hotels ADD COLUMN IF NOT EXISTS commission_value NUMERIC;
ALTER TABLE hotels ADD COLUMN IF NOT EXISTS fixed_advance_amount NUMERIC DEFAULT 0;

ALTER TABLE hotels ADD COLUMN IF NOT EXISTS display_order INTEGER DEFAULT 0;
ALTER TABLE rafting ADD COLUMN IF NOT EXISTS display_order INTEGER DEFAULT 0;
ALTER TABLE bikes ADD COLUMN IF NOT EXISTS display_order INTEGER DEFAULT 0;
ALTER TABLE vendors ADD COLUMN IF NOT EXISTS display_order INTEGER DEFAULT 0;
