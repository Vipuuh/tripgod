  ...
  return (
    <section className="py-3 sm:py-5 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <div 
        ...
        className="group relative bg-[#FFF8F5] border border-[#FF5F00]/20 hover:border-[#FF5F00]/50 rounded-2xl p-4 sm:p-5 overflow-hidden shadow-xs hover:shadow-md transition-all duration-300 cursor-pointer"
      >
        {/* Subtle Decorative Accent Glow */}
        <div className="absolute -right-6 -bottom-6 w-40 h-40 bg-[#FF5F00]/10 rounded-full blur-xl pointer-events-none" />
        ...
        <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          ...
          <div className="space-y-1 max-w-xl">
            ...
            <p className="text-xs text-slate-500 font-medium line-clamp-1">
              Add Hotel, Rafting & Scooty. Auto-unlock 5%, 10%, 15% OFF + Instant WhatsApp Location Vouchers!
            </p>
          </div>
