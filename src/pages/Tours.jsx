          ...
          mapped.forEach(item => {
            ...
            if (!partnersMap[vendor.id]) {
              ...
              partnersMap[vendor.id] = {
                ...
                shop_image: vendor.shop_image || (vendor.shop_images && vendor.shop_images[0]) || 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?q=80&w=600',
                shop_images: Array.isArray(vendor.shop_images) && vendor.shop_images.length > 0 
                  ? vendor.shop_images 
                  : [(vendor.shop_image || 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?q=80&w=600')],
                    ...
                    {checkIfClosed(selectedTour).closed ? (
                      ...
                      <button
                        onClick={() => openBookingModal({
                          ...
                          vendor_id: selectedTour.vendor_id || selectedPartner?.id,
                          maps_link: selectedPartner?.google_maps_link || selectedTour?.maps_link || selectedTour?.google_maps_link,
                          google_maps_link: selectedPartner?.google_maps_link || selectedTour?.maps_link || selectedTour?.google_maps_link,
                          operatorPhone: selectedPartner?.whatsapp || selectedPartner?.phone || selectedTour?.phone_number || selectedTour?.whatsapp_number,
                          whatsapp_number: selectedPartner?.whatsapp || selectedPartner?.phone || selectedTour?.phone_number || selectedTour?.whatsapp_number,
                          payment_mode: pMode,
